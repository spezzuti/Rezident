...
WizardStyle=modern
; Themed installer: the setup exe carries the Rezident R icon, and the wizard
; pages use the dark vault-terminal banner art (generated by make_installer_art.py).
SetupIconFile=..\backend\desktop\assets\agentos.ico
